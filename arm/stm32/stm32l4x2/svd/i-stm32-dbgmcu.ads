...
package Interfaces.STM32.DBGMCU is
   ...
   subtype APB1FZR1_DBG_TIM2_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_TIM6_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_TIM7_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_RTC_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_WWDG_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_IWDG_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_I2C1_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_I2C2_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_I2C3_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_CAN_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZR1_DBG_LPTIM1_STOP_Field is Interfaces.STM32.Bit;
   ...
   subtype APB1FZR2_DBG_LPTIM2_STOP_Field is Interfaces.STM32.Bit;
   ...
   subtype APB2FZR_DBG_TIM1_STOP_Field is Interfaces.STM32.Bit;
   subtype APB2FZR_DBG_TIM15_STOP_Field is Interfaces.STM32.Bit;
   subtype APB2FZR_DBG_TIM16_STOP_Field is Interfaces.STM32.Bit;
