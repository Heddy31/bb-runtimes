...
package Interfaces.STM32.Flash is
   ...
   subtype CR_PNB_Field is Interfaces.STM32.Byte;
   ...
   subtype OPTR_DUALBANK_Field is Interfaces.STM32.Bit;
   ...
   type OPTR_Register is record
      ...
      --  unspecified
      Reserved_26_31 : Interfaces.STM32.UInt6 := 16#3C#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PCROP1SR_PCROP1_STRT_Field is Interfaces.STM32.UInt16;
   ...
   type PCROP1SR_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.STM32.UInt16 := 16#FFFF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PCROP1ER_PCROP1_END_Field is Interfaces.STM32.UInt16;
   ...
   type PCROP1ER_Register is record
      ...
      --  unspecified
      Reserved_16_30 : Interfaces.STM32.UInt15 := 16#FFF#;
   ...
   subtype WRP1AR_WRP1A_STRT_Field is Interfaces.STM32.Byte;
   subtype WRP1AR_WRP1A_END_Field is Interfaces.STM32.Byte;
   ...
   type WRP1AR_Register is record
      ...
      --  unspecified
      Reserved_24_31 : Interfaces.STM32.Byte := 16#FF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype WRP1BR_WRP1B_END_Field is Interfaces.STM32.Byte;
   subtype WRP1BR_WRP1B_STRT_Field is Interfaces.STM32.Byte;
   ...
   subtype PCROP2SR_PCROP2_STRT_Field is Interfaces.STM32.UInt16;
   ...
   subtype PCROP2ER_PCROP2_END_Field is Interfaces.STM32.UInt16;
   ...
   subtype WRP2AR_WRP2A_STRT_Field is Interfaces.STM32.Byte;
   subtype WRP2AR_WRP2A_END_Field is Interfaces.STM32.Byte;
   ...
   subtype WRP2BR_WRP2B_STRT_Field is Interfaces.STM32.Byte;
   subtype WRP2BR_WRP2B_END_Field is Interfaces.STM32.Byte;
