...
package Interfaces.STM32.CAN is
   ...
   subtype MCR_INRQ_Field is Interfaces.STM32.Bit;
   subtype MCR_SLEEP_Field is Interfaces.STM32.Bit;
   subtype MCR_TXFP_Field is Interfaces.STM32.Bit;
   subtype MCR_RFLM_Field is Interfaces.STM32.Bit;
   subtype MCR_NART_Field is Interfaces.STM32.Bit;
   subtype MCR_AWUM_Field is Interfaces.STM32.Bit;
   subtype MCR_ABOM_Field is Interfaces.STM32.Bit;
   subtype MCR_TTCM_Field is Interfaces.STM32.Bit;
   subtype MCR_RESET_Field is Interfaces.STM32.Bit;
   subtype MCR_DBF_Field is Interfaces.STM32.Bit;
   ...
   subtype MSR_INAK_Field is Interfaces.STM32.Bit;
   subtype MSR_SLAK_Field is Interfaces.STM32.Bit;
   subtype MSR_ERRI_Field is Interfaces.STM32.Bit;
   subtype MSR_WKUI_Field is Interfaces.STM32.Bit;
   subtype MSR_SLAKI_Field is Interfaces.STM32.Bit;
   subtype MSR_TXM_Field is Interfaces.STM32.Bit;
   subtype MSR_RXM_Field is Interfaces.STM32.Bit;
   subtype MSR_SAMP_Field is Interfaces.STM32.Bit;
   subtype MSR_RX_Field is Interfaces.STM32.Bit;
   ...
   subtype TSR_RQCP0_Field is Interfaces.STM32.Bit;
   subtype TSR_TXOK0_Field is Interfaces.STM32.Bit;
   subtype TSR_ALST0_Field is Interfaces.STM32.Bit;
   subtype TSR_TERR0_Field is Interfaces.STM32.Bit;
   subtype TSR_ABRQ0_Field is Interfaces.STM32.Bit;
   subtype TSR_RQCP1_Field is Interfaces.STM32.Bit;
   subtype TSR_TXOK1_Field is Interfaces.STM32.Bit;
   subtype TSR_ALST1_Field is Interfaces.STM32.Bit;
   subtype TSR_TERR1_Field is Interfaces.STM32.Bit;
   subtype TSR_ABRQ1_Field is Interfaces.STM32.Bit;
   subtype TSR_RQCP2_Field is Interfaces.STM32.Bit;
   subtype TSR_TXOK2_Field is Interfaces.STM32.Bit;
   subtype TSR_ALST2_Field is Interfaces.STM32.Bit;
   subtype TSR_TERR2_Field is Interfaces.STM32.Bit;
   subtype TSR_ABRQ2_Field is Interfaces.STM32.Bit;
   subtype TSR_CODE_Field is Interfaces.STM32.UInt2;
   --  TSR_TME array element
   subtype TSR_TME_Element is Interfaces.STM32.Bit;
   ...
   subtype TSR_LOW_Element is Interfaces.STM32.Bit;
   ...
   subtype RF0R_FMP0_Field is Interfaces.STM32.UInt2;
   subtype RF0R_FULL0_Field is Interfaces.STM32.Bit;
   subtype RF0R_FOVR0_Field is Interfaces.STM32.Bit;
   subtype RF0R_RFOM0_Field is Interfaces.STM32.Bit;
   ...
   subtype RF1R_FMP1_Field is Interfaces.STM32.UInt2;
   subtype RF1R_FULL1_Field is Interfaces.STM32.Bit;
   subtype RF1R_FOVR1_Field is Interfaces.STM32.Bit;
   subtype RF1R_RFOM1_Field is Interfaces.STM32.Bit;
   ...
   subtype IER_TMEIE_Field is Interfaces.STM32.Bit;
   subtype IER_FMPIE0_Field is Interfaces.STM32.Bit;
   subtype IER_FFIE0_Field is Interfaces.STM32.Bit;
   subtype IER_FOVIE0_Field is Interfaces.STM32.Bit;
   subtype IER_FMPIE1_Field is Interfaces.STM32.Bit;
   subtype IER_FFIE1_Field is Interfaces.STM32.Bit;
   subtype IER_FOVIE1_Field is Interfaces.STM32.Bit;
   subtype IER_EWGIE_Field is Interfaces.STM32.Bit;
   subtype IER_EPVIE_Field is Interfaces.STM32.Bit;
   subtype IER_BOFIE_Field is Interfaces.STM32.Bit;
   subtype IER_LECIE_Field is Interfaces.STM32.Bit;
   subtype IER_ERRIE_Field is Interfaces.STM32.Bit;
   subtype IER_WKUIE_Field is Interfaces.STM32.Bit;
   subtype IER_SLKIE_Field is Interfaces.STM32.Bit;
   ...
   subtype ESR_EWGF_Field is Interfaces.STM32.Bit;
   subtype ESR_EPVF_Field is Interfaces.STM32.Bit;
   subtype ESR_BOFF_Field is Interfaces.STM32.Bit;
   subtype ESR_LEC_Field is Interfaces.STM32.UInt3;
   subtype ESR_TEC_Field is Interfaces.STM32.Byte;
   subtype ESR_REC_Field is Interfaces.STM32.Byte;
   ...
   subtype BTR_BRP_Field is Interfaces.STM32.UInt10;
   subtype BTR_TS1_Field is Interfaces.STM32.UInt4;
   subtype BTR_TS2_Field is Interfaces.STM32.UInt3;
   subtype BTR_SJW_Field is Interfaces.STM32.UInt2;
   subtype BTR_LBKM_Field is Interfaces.STM32.Bit;
   subtype BTR_SILM_Field is Interfaces.STM32.Bit;
   ...
   subtype TI0R_TXRQ_Field is Interfaces.STM32.Bit;
   subtype TI0R_RTR_Field is Interfaces.STM32.Bit;
   subtype TI0R_IDE_Field is Interfaces.STM32.Bit;
   subtype TI0R_EXID_Field is Interfaces.STM32.UInt18;
   subtype TI0R_STID_Field is Interfaces.STM32.UInt11;
   ...
   subtype TDT0R_DLC_Field is Interfaces.STM32.UInt4;
   subtype TDT0R_TGT_Field is Interfaces.STM32.Bit;
   subtype TDT0R_TIME_Field is Interfaces.STM32.UInt16;
   ...
   subtype TDL0R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype TDH0R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype TI1R_TXRQ_Field is Interfaces.STM32.Bit;
   subtype TI1R_RTR_Field is Interfaces.STM32.Bit;
   subtype TI1R_IDE_Field is Interfaces.STM32.Bit;
   subtype TI1R_EXID_Field is Interfaces.STM32.UInt18;
   subtype TI1R_STID_Field is Interfaces.STM32.UInt11;
   ...
   subtype TDT1R_DLC_Field is Interfaces.STM32.UInt4;
   subtype TDT1R_TGT_Field is Interfaces.STM32.Bit;
   subtype TDT1R_TIME_Field is Interfaces.STM32.UInt16;
   ...
   subtype TDL1R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype TDH1R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype TI2R_TXRQ_Field is Interfaces.STM32.Bit;
   subtype TI2R_RTR_Field is Interfaces.STM32.Bit;
   subtype TI2R_IDE_Field is Interfaces.STM32.Bit;
   subtype TI2R_EXID_Field is Interfaces.STM32.UInt18;
   subtype TI2R_STID_Field is Interfaces.STM32.UInt11;
   ...
   subtype TDT2R_DLC_Field is Interfaces.STM32.UInt4;
   subtype TDT2R_TGT_Field is Interfaces.STM32.Bit;
   subtype TDT2R_TIME_Field is Interfaces.STM32.UInt16;
   ...
   subtype TDL2R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype TDH2R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype RI0R_RTR_Field is Interfaces.STM32.Bit;
   subtype RI0R_IDE_Field is Interfaces.STM32.Bit;
   subtype RI0R_EXID_Field is Interfaces.STM32.UInt18;
   subtype RI0R_STID_Field is Interfaces.STM32.UInt11;
   ...
   subtype RDT0R_DLC_Field is Interfaces.STM32.UInt4;
   subtype RDT0R_FMI_Field is Interfaces.STM32.Byte;
   subtype RDT0R_TIME_Field is Interfaces.STM32.UInt16;
   ...
   subtype RDL0R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype RDH0R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype RI1R_RTR_Field is Interfaces.STM32.Bit;
   subtype RI1R_IDE_Field is Interfaces.STM32.Bit;
   subtype RI1R_EXID_Field is Interfaces.STM32.UInt18;
   subtype RI1R_STID_Field is Interfaces.STM32.UInt11;
   ...
   subtype RDT1R_DLC_Field is Interfaces.STM32.UInt4;
   subtype RDT1R_FMI_Field is Interfaces.STM32.Byte;
   subtype RDT1R_TIME_Field is Interfaces.STM32.UInt16;
   ...
   subtype RDL1R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype RDH1R_DATA_Element is Interfaces.STM32.Byte;
   ...
   subtype FMR_FINIT_Field is Interfaces.STM32.Bit;
   ...
   type FMR_Register is record
      ...
      --  unspecified
      Reserved_1_31 : Interfaces.STM32.UInt31 := 16#150E0700#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FM1R_FBM_Element is Interfaces.STM32.Bit;

   --  FM1R_FBM array
   type FM1R_FBM_Field_Array is array (0 .. 13) of FM1R_FBM_Element
   ...
   subtype FS1R_FSC_Element is Interfaces.STM32.Bit;

   --  FS1R_FSC array
   type FS1R_FSC_Field_Array is array (0 .. 13) of FS1R_FSC_Element
     with Component_Size => 1, Size => 14;
   ...
   subtype FFA1R_FFA_Element is Interfaces.STM32.Bit;

   --  FFA1R_FFA array
   type FFA1R_FFA_Field_Array is array (0 .. 13) of FFA1R_FFA_Element
     with Component_Size => 1, Size => 14;
   ...
   subtype FA1R_FACT_Element is Interfaces.STM32.Bit;

   --  FA1R_FACT array
   type FA1R_FACT_Field_Array is array (0 .. 13) of FA1R_FACT_Element
     with Component_Size => 1, Size => 14;
   ...
   subtype F14R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F15R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F16R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F17R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F18R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F19R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F20R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F21R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F22R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F23R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F24R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F25R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F26R_FB_Element is Interfaces.STM32.Bit;
   ...
   subtype F27R_FB_Element is Interfaces.STM32.Bit;
