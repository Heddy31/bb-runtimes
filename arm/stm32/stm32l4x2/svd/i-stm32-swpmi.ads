...
package Interfaces.STM32.SWPMI is
   ...
   subtype CR_RXDMA_Field is Interfaces.STM32.Bit;
   subtype CR_TXDMA_Field is Interfaces.STM32.Bit;
   subtype CR_RXMODE_Field is Interfaces.STM32.Bit;
   subtype CR_TXMODE_Field is Interfaces.STM32.Bit;
   subtype CR_LPBK_Field is Interfaces.STM32.Bit;
   subtype CR_SWPME_Field is Interfaces.STM32.Bit;
   subtype CR_DEACT_Field is Interfaces.STM32.Bit;
   ...
   subtype BRR_BR_Field is Interfaces.STM32.UInt6;
   ...
   subtype ISR_RXBFF_Field is Interfaces.STM32.Bit;
   subtype ISR_TXBEF_Field is Interfaces.STM32.Bit;
   subtype ISR_RXBERF_Field is Interfaces.STM32.Bit;
   subtype ISR_RXOVRF_Field is Interfaces.STM32.Bit;
   subtype ISR_TXUNRF_Field is Interfaces.STM32.Bit;
   subtype ISR_RXNE_Field is Interfaces.STM32.Bit;
   subtype ISR_TXE_Field is Interfaces.STM32.Bit;
   subtype ISR_TCF_Field is Interfaces.STM32.Bit;
   subtype ISR_SRF_Field is Interfaces.STM32.Bit;
   subtype ISR_SUSP_Field is Interfaces.STM32.Bit;
   subtype ISR_DEACTF_Field is Interfaces.STM32.Bit;
   ...
   subtype ICR_CRXBFF_Field is Interfaces.STM32.Bit;
   subtype ICR_CTXBEF_Field is Interfaces.STM32.Bit;
   subtype ICR_CRXBERF_Field is Interfaces.STM32.Bit;
   subtype ICR_CRXOVRF_Field is Interfaces.STM32.Bit;
   subtype ICR_CTXUNRF_Field is Interfaces.STM32.Bit;
   subtype ICR_CTCF_Field is Interfaces.STM32.Bit;
   subtype ICR_CSRF_Field is Interfaces.STM32.Bit;
   ...
   subtype IER_RXBFIE_Field is Interfaces.STM32.Bit;
   subtype IER_TXBEIE_Field is Interfaces.STM32.Bit;
   subtype IER_RXBERIE_Field is Interfaces.STM32.Bit;
   subtype IER_RXOVRIE_Field is Interfaces.STM32.Bit;
   subtype IER_TXUNRIE_Field is Interfaces.STM32.Bit;
   subtype IER_RIE_Field is Interfaces.STM32.Bit;
   subtype IER_TIE_Field is Interfaces.STM32.Bit;
   subtype IER_TCIE_Field is Interfaces.STM32.Bit;
   subtype IER_SRIE_Field is Interfaces.STM32.Bit;
   ...
   subtype RFL_RFL_Field is Interfaces.STM32.UInt5;
   ...
   type RFL_Register is record
      ...
      RFL           : RFL_RFL_Field;
      --  unspecified
      Reserved_5_31 : Interfaces.STM32.UInt27;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SWPMI1_Peripheral is record
      ...
      TDR : aliased Interfaces.STM32.UInt32;
      --  SWPMI Receive data register
      RDR : aliased Interfaces.STM32.UInt32;
   end record
     with Volatile;
