...
package Interfaces.STM32.EXTI is
   ...
   subtype IMR1_MR_Element is Interfaces.STM32.Bit;
   ...
   subtype EMR1_MR_Element is Interfaces.STM32.Bit;
   ...
   subtype RTSR1_TR_Element is Interfaces.STM32.Bit;

   --  RTSR1_TR array
   type RTSR1_TR_Field_Array is array (0 .. 16) of RTSR1_TR_Element
   ...
   --  RTSR1_TR array
   type RTSR1_TR_Field_Array_1 is array (18 .. 22) of RTSR1_TR_Element
   ...
   subtype FTSR1_TR_Element is Interfaces.STM32.Bit;

   --  FTSR1_TR array
   type FTSR1_TR_Field_Array is array (0 .. 16) of FTSR1_TR_Element
     with Component_Size => 1, Size => 17;
   ...
   --  FTSR1_TR array
   type FTSR1_TR_Field_Array_1 is array (18 .. 22) of FTSR1_TR_Element
     with Component_Size => 1, Size => 5;
   ...
   subtype SWIER1_SWIER_Element is Interfaces.STM32.Bit;

   --  SWIER1_SWIER array
   type SWIER1_SWIER_Field_Array is array (0 .. 16) of SWIER1_SWIER_Element
     with Component_Size => 1, Size => 17;
   ...
   --  SWIER1_SWIER array
   type SWIER1_SWIER_Field_Array_1 is array (18 .. 22)
   ...
   subtype PR1_PR_Element is Interfaces.STM32.Bit;

   --  PR1_PR array
   type PR1_PR_Field_Array is array (0 .. 16) of PR1_PR_Element
     with Component_Size => 1, Size => 17;
   ...
   --  PR1_PR array
   type PR1_PR_Field_Array_1 is array (18 .. 22) of PR1_PR_Element
     with Component_Size => 1, Size => 5;
   ...
   subtype IMR2_MR_Element is Interfaces.STM32.Bit;

   --  IMR2_MR array
   type IMR2_MR_Field_Array is array (32 .. 39) of IMR2_MR_Element
   ...
   type IMR2_Register is record
      ...
      --  unspecified
      Reserved_8_31 : Interfaces.STM32.UInt24 := 16#FFFFFF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype EMR2_MR_Element is Interfaces.STM32.Bit;

   --  EMR2_MR array
   type EMR2_MR_Field_Array is array (32 .. 39) of EMR2_MR_Element
     with Component_Size => 1, Size => 8;
   ...
   --  RTSR2_RT array
   type RTSR2_RT_Field_Array is array (35 .. 38) of RTSR2_RT_Element
