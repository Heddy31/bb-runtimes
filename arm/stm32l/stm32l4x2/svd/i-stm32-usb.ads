...
package Interfaces.STM32.USB is
   ...
   subtype LPMCSR_LPMEN_Field is Interfaces.STM32.Bit;
   subtype LPMCSR_LPMACK_Field is Interfaces.STM32.Bit;
   subtype LPMCSR_REMWAKE_Field is Interfaces.STM32.Bit;
   subtype LPMCSR_BESL_Field is Interfaces.STM32.UInt4;
   ...
   subtype BCDR_BCDEN_Field is Interfaces.STM32.Bit;
   subtype BCDR_DCDEN_Field is Interfaces.STM32.Bit;
   subtype BCDR_PDEN_Field is Interfaces.STM32.Bit;
   subtype BCDR_SDEN_Field is Interfaces.STM32.Bit;
   subtype BCDR_DCDET_Field is Interfaces.STM32.Bit;
   subtype BCDR_PDET_Field is Interfaces.STM32.Bit;
   subtype BCDR_SDET_Field is Interfaces.STM32.Bit;
   subtype BCDR_PS2DET_Field is Interfaces.STM32.Bit;
   subtype BCDR_DPPU_Field is Interfaces.STM32.Bit;
