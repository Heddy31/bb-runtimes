...
package Interfaces.STM32.VREF is
   ...
   subtype CSR_ENVR_Field is Interfaces.STM32.Bit;
   subtype CSR_HIZ_Field is Interfaces.STM32.Bit;
   subtype CSR_VRS_Field is Interfaces.STM32.Bit;
   subtype CSR_VRR_Field is Interfaces.STM32.Bit;
   ...
   subtype CCR_TRIM_Field is Interfaces.STM32.UInt6;
