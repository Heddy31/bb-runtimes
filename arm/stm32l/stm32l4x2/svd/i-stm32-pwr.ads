...
package Interfaces.STM32.PWR is
   ...
   subtype CR2_PVME_Element is Interfaces.STM32.Bit;
   ...
   subtype CR2_IOSV_Field is Interfaces.STM32.Bit;
   subtype CR2_USV_Field is Interfaces.STM32.Bit;
   ...
   subtype CR3_EWF_Field is Interfaces.STM32.Bit;
   ...
   subtype SR1_CWUF_Element is Interfaces.STM32.Bit;
   ...
   subtype SR1_CSBF_Field is Interfaces.STM32.Bit;
   ...
   subtype SCR_WUF_Element is Interfaces.STM32.Bit;
   ...
   subtype SCR_SBF_Field is Interfaces.STM32.Bit;
   ...
   subtype PUCRH_PU_Element is Interfaces.STM32.Bit;
   ...
   subtype PDCRH_PD_Element is Interfaces.STM32.Bit;
