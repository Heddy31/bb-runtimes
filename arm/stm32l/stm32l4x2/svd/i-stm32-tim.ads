...
package Interfaces.STM32.TIM is
   ...
   subtype OR1_ETR_ADC1_RMP_Field is Interfaces.STM32.UInt2;
   subtype OR1_ETR_ADC3_RMP_Field is Interfaces.STM32.UInt2;
   subtype OR1_TI1_RMP_Field is Interfaces.STM32.Bit;
   ...
   subtype OR2_BKINE_Field is Interfaces.STM32.Bit;
   subtype OR2_BKCMP1E_Field is Interfaces.STM32.Bit;
   subtype OR2_BKCMP2E_Field is Interfaces.STM32.Bit;
   subtype OR2_BKDFBK0E_Field is Interfaces.STM32.Bit;
   subtype OR2_BKINP_Field is Interfaces.STM32.Bit;
   subtype OR2_BKCMP1P_Field is Interfaces.STM32.Bit;
   subtype OR2_BKCMP2P_Field is Interfaces.STM32.Bit;
   subtype OR2_ETRSEL_Field is Interfaces.STM32.UInt3;

   --  DMA address for full transfer
   type OR2_Register is record
      --  BRK BKIN input enable
      BKINE          : OR2_BKINE_Field := 16#1#;
      --  BRK COMP1 enable
      BKCMP1E        : OR2_BKCMP1E_Field := 16#0#;
      --  BRK COMP2 enable
      BKCMP2E        : OR2_BKCMP2E_Field := 16#0#;
      --  unspecified
      Reserved_3_7   : Interfaces.STM32.UInt5 := 16#0#;
      --  BRK DFSDM_BREAK0 enable
      BKDFBK0E       : OR2_BKDFBK0E_Field := 16#0#;
      --  BRK BKIN input polarity
      BKINP          : OR2_BKINP_Field := 16#0#;
      --  BRK COMP1 input polarity
      BKCMP1P        : OR2_BKCMP1P_Field := 16#0#;
      --  BRK COMP2 input polarity
      BKCMP2P        : OR2_BKCMP2P_Field := 16#0#;
      --  unspecified
   ...
   subtype OR3_BK2INE_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2CMP1E_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2CMP2E_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2DFBK0E_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2INP_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2CMP1P_Field is Interfaces.STM32.Bit;
   subtype OR3_BK2CMP2P_Field is Interfaces.STM32.Bit;

   --  DMA address for full transfer
   type OR3_Register is record
      --  BRK2 BKIN input enable
      BK2INE         : OR3_BK2INE_Field := 16#1#;
      --  BRK2 COMP1 enable
      BK2CMP1E       : OR3_BK2CMP1E_Field := 16#0#;
      --  BRK2 COMP2 enable
      BK2CMP2E       : OR3_BK2CMP2E_Field := 16#0#;
      --  unspecified
      Reserved_3_7   : Interfaces.STM32.UInt5 := 16#0#;
      --  BRK2 DFSDM_BREAK0 enable
      BK2DFBK0E      : OR3_BK2DFBK0E_Field := 16#0#;
      --  BRK2 BKIN input polarity
      BK2INP         : OR3_BK2INP_Field := 16#0#;
      --  BRK2 COMP1 input polarity
      BK2CMP1P       : OR3_BK2CMP1P_Field := 16#0#;
      --  BRK2 COMP2 input polarity
      BK2CMP2P       : OR3_BK2CMP2P_Field := 16#0#;
      --  unspecified
   ...
   subtype OR_ETR_RMP_Field is Interfaces.STM32.UInt3;
   subtype OR_TI4_RMP_Field is Interfaces.STM32.UInt2;
   ...
   subtype CCMR1_Output_OC1M_2_Field is Interfaces.STM32.Bit;
   ...
   type CCMR1_Output_Register_1 is record
      ...
      --  Output Compare 1 mode
      OC1M_2         : CCMR1_Output_OC1M_2_Field := 16#0#;
      --  unspecified
      Reserved_17_31 : Interfaces.STM32.UInt15 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype OR1_TI1_RMP_Field_1 is Interfaces.STM32.UInt2;
   ...
   subtype OR2_BKDFBK1E_Field is Interfaces.STM32.Bit;

   --  TIM17 option register 1
   type OR2_Register_1 is record
      --  BRK BKIN input enable
      BKINE          : OR2_BKINE_Field := 16#0#;
      --  BRK COMP1 enable
      BKCMP1E        : OR2_BKCMP1E_Field := 16#0#;
      --  BRK COMP2 enable
      BKCMP2E        : OR2_BKCMP2E_Field := 16#0#;
      ...
      BKDFBK1E       : OR2_BKDFBK1E_Field := 16#0#;
      --  BRK BKIN input polarity
      BKINP          : OR2_BKINP_Field := 16#0#;
      --  BRK COMP1 input polarity
      BKCMP1P        : OR2_BKCMP1P_Field := 16#0#;
