...
package Interfaces.STM32.QUADSPI is
   ...
   subtype CR_ABORT_Field is Interfaces.STM32.Bit;
   subtype CR_DMAEN_Field is Interfaces.STM32.Bit;
   subtype CR_TCEN_Field is Interfaces.STM32.Bit;
   subtype CR_SSHIFT_Field is Interfaces.STM32.Bit;
   subtype CR_DFM_Field is Interfaces.STM32.Bit;
   subtype CR_FSEL_Field is Interfaces.STM32.Bit;
   subtype CR_FTHRES_Field is Interfaces.STM32.UInt5;
   subtype CR_TEIE_Field is Interfaces.STM32.Bit;
   subtype CR_TCIE_Field is Interfaces.STM32.Bit;
   subtype CR_FTIE_Field is Interfaces.STM32.Bit;
   subtype CR_SMIE_Field is Interfaces.STM32.Bit;
   subtype CR_TOIE_Field is Interfaces.STM32.Bit;
   subtype CR_APMS_Field is Interfaces.STM32.Bit;
   subtype CR_PMM_Field is Interfaces.STM32.Bit;
   subtype CR_PRESCALER_Field is Interfaces.STM32.Byte;
   ...
   subtype DCR_CKMODE_Field is Interfaces.STM32.Bit;
   subtype DCR_CSHT_Field is Interfaces.STM32.UInt3;
   subtype DCR_FSIZE_Field is Interfaces.STM32.UInt5;
   ...
   subtype SR_TEF_Field is Interfaces.STM32.Bit;
   subtype SR_TCF_Field is Interfaces.STM32.Bit;
   subtype SR_FTF_Field is Interfaces.STM32.Bit;
   subtype SR_SMF_Field is Interfaces.STM32.Bit;
   subtype SR_TOF_Field is Interfaces.STM32.Bit;
   subtype SR_BUSY_Field is Interfaces.STM32.Bit;
   subtype SR_FLEVEL_Field is Interfaces.STM32.UInt7;
   ...
   subtype FCR_CTEF_Field is Interfaces.STM32.Bit;
   subtype FCR_CTCF_Field is Interfaces.STM32.Bit;
   subtype FCR_CSMF_Field is Interfaces.STM32.Bit;
   subtype FCR_CTOF_Field is Interfaces.STM32.Bit;
   ...
   subtype CCR_INSTRUCTION_Field is Interfaces.STM32.Byte;
   subtype CCR_IMODE_Field is Interfaces.STM32.UInt2;
   subtype CCR_ADMODE_Field is Interfaces.STM32.UInt2;
   subtype CCR_ADSIZE_Field is Interfaces.STM32.UInt2;
   subtype CCR_ABMODE_Field is Interfaces.STM32.UInt2;
   subtype CCR_ABSIZE_Field is Interfaces.STM32.UInt2;
   subtype CCR_DCYC_Field is Interfaces.STM32.UInt5;
   subtype CCR_DMODE_Field is Interfaces.STM32.UInt2;
   subtype CCR_FMODE_Field is Interfaces.STM32.UInt2;
   subtype CCR_SIOO_Field is Interfaces.STM32.Bit;
   subtype CCR_DHHC_Field is Interfaces.STM32.Bit;
   subtype CCR_DDRM_Field is Interfaces.STM32.Bit;
   ...
   subtype PIR_INTERVAL_Field is Interfaces.STM32.UInt16;
   ...
   subtype LPTR_TIMEOUT_Field is Interfaces.STM32.UInt16;
   ...
   type QUADSPI_Peripheral is record
      ...
      DLR   : aliased Interfaces.STM32.UInt32;
      --  communication configuration register
      CCR   : aliased CCR_Register;
      --  address register
      AR    : aliased Interfaces.STM32.UInt32;
      --  ABR
      ABR   : aliased Interfaces.STM32.UInt32;
      --  data register
      DR    : aliased Interfaces.STM32.UInt32;
      --  polling status mask register
      PSMKR : aliased Interfaces.STM32.UInt32;
      --  polling status match register
      PSMAR : aliased Interfaces.STM32.UInt32;
      --  polling interval register
